 ...
 *
 */
class Novaworks_ThemeOptions_Block_Adminhtml_System_Config_Form_Field_Stars extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    {        
	    ...
	    $html .= '<div class="nova-stars"><img src="'.Mage::getDesign()->getSkinUrl('stars/'.$option['value'].'.png').'" /></div>';
