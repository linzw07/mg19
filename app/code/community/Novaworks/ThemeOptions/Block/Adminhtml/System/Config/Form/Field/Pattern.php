 ...
 *
 */
class Novaworks_ThemeOptions_Block_Adminhtml_System_Config_Form_Field_pattern extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _optionToHtml($element, $option, $selected)
    {
        ...
        $html = '<div class="'.$float.' a-center nova-radio">';
	    $html .= '<div class="nova-thumb" style="background:url('.Mage::getDesign()->getSkinUrl('paterns/'.$option['value'].'.png').') 0 0 repeat;"></div>';
