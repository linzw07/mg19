 ...
 *
 */
class Novaworks_ThemeOptions_Block_Adminhtml_System_Config_Form_Field_Imagessmall extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    {        
        $html = '<div class="left a-center nova-radio">';
	    $html .= '<div class="nova-thumb"><img src="'.Mage::getDesign()->getSkinUrl('options_images/'.$option['value'].'.png').'" /></div>';
