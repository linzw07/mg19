...
class Novaworks_CustomWidgets_Model_Layout
{
    ...
    {    
			...
			return array(
            	...
            	array('value'=>'2_columns_left', 'label'=>Mage::helper('adminhtml')->__('2 Columns (Layout Left)')),
            	array('value'=>'2_columns_right', 'label'=>Mage::helper('adminhtml')->__('2 Columns (Layout Left)'))            	
        	);
    } 
}
