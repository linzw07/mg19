...
class Novaworks_Megamenu_Block_Mainmenu_Menu extends Mage_Catalog_Block_Navigation
{
                                                   ...
                                                   $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
        ...
        if($pageURL == $catdetail->getData('mtmenu_cat_custom_link')) {
	        $classes[] = 'active';
        }
        $linkClass = '';
        ...
        if($catdetail->getData('mtmenu_cat_custom_link')) {
	        $html[] = '<a href="'.$catdetail->getData('mtmenu_cat_custom_link').'"'.$linkClass.'>';
        }else{
        ...
        if ($level == 0) {
            ...
            if ($cat_block_proportions = $catdetail->getData('mtmenu_cat_block_proportions')) {
                ...
                if(isset($cat_block_proportions[1])) {
